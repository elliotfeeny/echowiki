...
## sidechain_eth_defrosted_deposit_operation

```cpp
struct sidechain_erc20_defrosted_withdraw_operation : public base_operation
{
   struct fee_parameters_type { uint64_t fee = 0; };
...
## sidechain_eth_defrosted_withdraw_operation
...
## sidechain_erc20_defrosted_deposit_operation

```cpp
struct sidechain_erc20_defrosted_deposit_operation : public base_operation
{
   struct fee_parameters_type { uint64_t fee = 0; };
...
## sidechain_erc20_defrosted_withdraw_operation
